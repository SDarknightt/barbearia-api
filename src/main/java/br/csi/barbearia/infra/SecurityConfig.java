        ...
        return http
                ...
                .authorizeHttpRequests(auth->
                        auth.requestMatchers(HttpMethod.POST,"/login").permitAll()
                                ...
                                .requestMatchers(HttpMethod.POST, "/agendamento").hasAnyAuthority("ROLE_ADMIN", "ROLE_FUNCIONARIO")
                                .requestMatchers(HttpMethod.PUT, "/agendamento").hasAnyAuthority("ROLE_ADMIN", "ROLE_FUNCIONARIO")
                                .requestMatchers(HttpMethod.GET, "/agendamento").hasAnyAuthority("ROLE_ADMIN", "ROLE_FUNCIONARIO")
                                .requestMatchers(HttpMethod.DELETE, "/agendamento").hasAnyAuthority("ROLE_ADMIN", "ROLE_FUNCIONARIO")
